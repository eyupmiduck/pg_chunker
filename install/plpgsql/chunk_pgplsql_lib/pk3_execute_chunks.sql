CREATE OR REPLACE PROCEDURE chunk_pgplsql_lib.pk3_execute_chunks(
...
DECLARE
    ...
    l_k1_e_k2_e_k3_n_stmt   VARCHAR(65535);

    l_k1_e_k2_n_1_stmt      VARCHAR(65535);
    l_k1_e_k2_n_2_stmt      VARCHAR(65535);
    l_k1_e_k2_n_3_stmt      VARCHAR(65535);

    l_k1_n_1_stmt           VARCHAR(65535);
    l_k1_n_2_stmt           VARCHAR(65535);
    l_k1_n_3_stmt           VARCHAR(65535);
    l_k1_n_4_stmt           VARCHAR(65535);
    l_k1_n_5_stmt           VARCHAR(65535);
...
BEGIN
    CALL chunk_pgplsql_lib.pk3_get_chunk_statements(
        ...
        o_k1_e_k2_e_k3_n_stmt   => l_k1_e_k2_e_k3_n_stmt,
        o_k1_e_k2_n_1_stmt      => l_k1_e_k2_n_1_stmt,
        o_k1_e_k2_n_2_stmt      => l_k1_e_k2_n_2_stmt,
        o_k1_e_k2_n_3_stmt      => l_k1_e_k2_n_3_stmt,
        o_k1_n_1_stmt           => l_k1_n_1_stmt,
        o_k1_n_2_stmt           => l_k1_n_2_stmt,
        o_k1_n_3_stmt           => l_k1_n_3_stmt,
        o_k1_n_4_stmt           => l_k1_n_4_stmt,
        o_k1_n_5_stmt           => l_k1_n_5_stmt,
    ...
    IF i_start_chunk <=  i_number_of_chunks THEN
        ...
        FOR l_current_chunk IN i_start_chunk..i_number_of_chunks LOOP
            ...
            IF l_current_chunk = i_number_of_chunks THEN
                ...
                CALL chunk_pgplsql_lib.pk3_execute_final(
            ...
            ELSE
                ...
                IF  NOT chunk_pgplsql_lib.is_key_equal(i_key1 => l_lower_boundary_record.pk_key1, i_key2 => l_upper_boundary_record.pk_key1)
                THEN
                    CALL chunk_pgplsql_lib.pk3_execute_k1_n(
                        i_lower_boundary_record => l_lower_boundary_record,
                        ...
                        i_k1_n_4_stmt           => l_k1_n_4_stmt,
                        i_k1_n_5_stmt           => l_k1_n_5_stmt
                    );
                ELSIF   chunk_pgplsql_lib.is_key_equal(i_key1 => l_lower_boundary_record.pk_key1, i_key2 => l_upper_boundary_record.pk_key1)
                AND NOT chunk_pgplsql_lib.is_key_equal(i_key1 => l_lower_boundary_record.pk_key2, i_key2 => l_upper_boundary_record.pk_key2) THEN
                    CALL chunk_pgplsql_lib.pk3_execute_k1_e_k2_n(
                        i_lower_boundary_record => l_lower_boundary_record,
                        i_upper_boundary_record => l_upper_boundary_record,
                        i_run_id                => i_run_id,
                        i_chunk_number          => l_current_chunk,
                ...
                ELSIF   chunk_pgplsql_lib.is_key_equal(i_key1 => l_lower_boundary_record.pk_key1, i_key2 => l_upper_boundary_record.pk_key1)
                AND     chunk_pgplsql_lib.is_key_equal(i_key1 => l_lower_boundary_record.pk_key2, i_key2 => l_upper_boundary_record.pk_key2)
                AND NOT chunk_pgplsql_lib.is_key_equal(i_key1 => l_lower_boundary_record.pk_key3, i_key2 => l_upper_boundary_record.pk_key3)
                THEN
                    CALL chunk_pgplsql_lib.pk3_execute_k1_e_k2_e_k3_n(
                        i_lower_boundary_record => l_lower_boundary_record,
                        i_upper_boundary_record => l_upper_boundary_record,
                        i_run_id                => i_run_id,
                        i_chunk_number          => l_current_chunk,
                        i_k1_e_k2_e_k3_n_stmt   => l_k1_e_k2_e_k3_n_stmt
                    );
                ELSE
