...
DROP TABLE IF EXISTS chunk_test_data_source.test_table_int_int_int_pk;
DROP TABLE IF EXISTS chunk_test_data_target.test_table_int_int_int_pk;
...
CREATE TABLE IF NOT EXISTS chunk_test_data_source.test_table_int_int_int_pk(
    key1        INTEGER NOT NULL,
    key2        INTEGER NOT NULL,
...
CREATE TABLE IF NOT EXISTS chunk_test_data_target.test_table_int_int_int_pk(
    key1        INTEGER NOT NULL,
    key2        INTEGER NOT NULL,
    key3        INTEGER NOT NULL,
    row_value   INTEGER NOT NULL,
